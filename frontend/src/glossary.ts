...
export const STEP_TERMS: Record<string, string[]> = {
  ...
  merchant_verified: ["verify_chain", "selective_disclosure", "sd_hash", "checkout_hash", "disclosures"],
  network_verified: ["verify_chain", "check_constraints", "strict_mode", "selective_disclosure", "sd_hash"],
